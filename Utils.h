...
// This class implements Hardware SPI (4 wire bus). It is not used in the default configuration (software SPI mode).
// When you compile the code for Linux, Windows or any other platform you must modify this class.
...
// This class implements Hardware I2C (2 wire bus). It is not used in the default configuration (software SPI mode).
// When you compile the code for Linux, Windows or any other platform you must modify this class.
